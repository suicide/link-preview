...
/**
 * The LinkPreviewService provides {@link LinkPreview}s from given Urls
 * 
...
public interface LinkPreviewService {
	...
	LinkPreview loadPreview(String url) throws LinkPreviewException;
	
	LinkPreview loadPreview(URL url) throws LinkPreviewException;
